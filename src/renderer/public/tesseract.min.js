    ...
    var t = {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (H = function (t) {
                          return B(
                            v({
                              ...
                              action: 'load',
                              payload: {
                                options: { lstmOnly: G, corePath: k.corePath, logging: k.logging }
                              }
                            })
                          )
                        }),
                        ...
                        (J = function (t, r) {
                          return B(
                            v({ id: r, action: 'FS', payload: { method: 'unlink', args: [t] } })
                          )
                        }),
                        (V = function (t, r, e) {
                            ...
                            v({
                              ...
                              payload: {
                                ...
                                options: {
                                  ...
                                  gzip: k.gzip,
                                  lstmOnly:
                                    [m.LSTM_ONLY, m.TESSERACT_LSTM_COMBINED].includes(A) &&
                                    !k.legacyLang
                                }
                              }
                            })
                                  ...
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 8:
                                      return (
                                        ...
                                        (t.t4 = e),
                                        (t.t5 = n),
                                        (t.t6 = { image: t.t3, options: t.t4, output: t.t5 }),
                                        (t.t7 = { id: t.t2, action: 'recognize', payload: t.t6 }),
                                        (t.t8 = (0, t.t1)(t.t7)),
                        ...
                        (et = function () {
                          ...
                          return (
                            ...
                            B(v({ id: e, action: 'getPDF', payload: { title: t, textonly: r } }))
                          )
                        }),
                        (nt = (function () {
                          var t = h(
                                  ...
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 7:
                                      return (
                                        (t.t3 = t.sent),
                                        (t.t4 = { image: t.t3 }),
                                        (t.t5 = { id: t.t2, action: 'detect', payload: t.t4 }),
                                        (t.t6 = (0, t.t1)(t.t5)),
                        ...
                        O(C, function (t) {
                          ...
                          if ('resolve' === n) {
                            ...
                            if ((T[o](i), 'load' === o && F(i), !P)) throw Error(i)
                            P(i)
        ...
        352: (t, r, e) => {
          ...
          t.exports = (function (t) {
            ...
            { languages: f, OEM: l, PSM: s, createScheduler: a, createWorker: c, setLogging: h },
            u
          )
        },
        549: (t) => {
                    ...
                    r.lines.forEach(function (e) {
                      e.words.forEach(function (o) {
                        o.symbols.forEach(function (i) {
                          a.push(
                            n(n({}, i), {}, { page: t, block: c, paragraph: r, line: e, word: o })
                          )
                        }),
        ...
        854: (t, r, e) => {
          ...
          t.exports = i(
            ...
            {},
            {
              ...
              //     '/dist/worker.min.js'
              //   )
              // workerPath: 'https://gomoon.bj.bcebos.com/tesseract/worker.min.js'
              workerPath: 'https://gomoon.top/api/assets/tesseract/worker.min.js'
            }
          )
        },
        581: (t, r, e) => {
